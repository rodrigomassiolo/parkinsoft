...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used for the parkinsoft web app Español
    |
    */
    ...
    */
    ...
    'infoProjList2Title' => 'Tiene como salida:',
    'infoProjList2Bullet1' => 'Generar distintos gráficos y datos, producto del procesamiento de los audios, que facilitarán al médico la posibilidad de realizar observaciones, análisis y sacar conclusiones sobre el estado actual de la voz del paciente en distintos momentos de la enfermedad, además de poder ver la evolución en el tiempo.',
    ...
    */
    ...
    'audioUploadFileNotFound' => 'Debe ingresar un archivo',
    'audioInvalidExercise' => 'El ejercicio solicitado es invalido',
    'audioNoMp3' => 'Debe ingresar un archivo que no sea formato mp3',

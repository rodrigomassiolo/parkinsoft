    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="float-right">
                <a class="btn btn-success btn-sm" href="{{ route('abmUser.create') }}"> Crear usuario</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3">
                <div class="form-group">
                    ...
                    placeholder="Apellido a filtrar" value= "{{Request::old('nacionalidad')}}">
                </div>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3">
                <div class="form-group">
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('abmUser.destroy',$row->id) }}" method="POST">
                    ...
                    <a class="btn btn-primary btn-sm" href="{{ route('abmUser.edit',$row->id) }}"><span class=""></span>Editar</a>

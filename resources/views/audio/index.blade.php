              ...
              <td>
                  <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <button type="button" class="btn btn-primary" id="{{$row->id}}" data-toggle="modal" data-target="#exampleModal" onclick="Lista.fillSelector({{$row->id}});" data-whatever="{{$row->id}}">@lang('parkinsoft.process')</button>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">

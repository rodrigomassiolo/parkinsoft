...
<form action="{{ route('sendAudio') }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row inputs">
    <div class="col-md-6 col-sm-6 col-lg-6">
      <label for="audio">@lang('parkinsoft.uploadAudioLabel')</label>
    ...
    <div class="col-md-4 col-sm-4 col-lg-4">
        <label for="origen_audio">@lang('parkinsoft.audioQuality')</label>
...
<br>
  <div class="centerButton">
      <button type="submit"> @lang('parkinsoft.sendButton') </button>
  </div>

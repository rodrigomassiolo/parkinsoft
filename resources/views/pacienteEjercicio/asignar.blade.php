...
<h4 class="titleInfo">
    @lang('parkinsoft.assignExercise')
</h4>
<br>
...
<form action="{{ route('ejercicioPacienteGuardar') }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row inputs">
    ...
    <div class="col-md-2 col-sm-2 col-lg-2">
        <label for="user">@lang('parkinsoft.patient')</label>
    ...
    <div class="col-md-2 col-sm-2 col-lg-2">
      <label for="es_levodopa">@lang('parkinsoft.isLevodopaLabel')</label>
...
<br>
  <div class="form-group row">
    <h6 class="ejercicioInfo" id ="ejercicioInfo">
        @lang('parkinsoft.exerciseDescription'):
    </h6>
  ...
  <div class="centerButton">
      <button type="submit"> @lang('parkinsoft.assign') </button>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">@lang('parkinsoft.assignExerciseModalTitle')</h5>

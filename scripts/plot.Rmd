...
# datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8] <- max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],7]) * datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8] / max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8])
# datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8] <- max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],7]) * datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8] / max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8])
# datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8] <- max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],7]) * datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8] / max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8])

resultado2F0_Vol_Prob$loudness <- datosprosody$pcm_loudness_sma
...
if (parenergy == 1) {
plot(energygraph)
kable(resultadoEnergy,caption="Tabla de los valores maximos, medios y bajos de Energy")
}
#############################################################################################
...
plot(F0_Prob)
plot(F0_Volumen)
kable(resultadoF0_Vol_Prob,caption="Tabla de los valores maximos, medios y bajos de F0, probabilidad y volumen")
}
#############################################################################################

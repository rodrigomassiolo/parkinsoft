...
resultadoChroma <- expand.grid(c('ID','DO', 'DO#', 'RE', 'RE#', 'MI' ,'FA', 'FA#', 'SOL', 'SOL#', 'LA', 'LA#', 'SI'))
resultadoChroma$Primero_Audio_minimo <- c(datosAudios$'nombre del audio'[1],min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],6]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],7]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],8]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],9]),
...
resultadoChroma$Primero_Audio_medio <- c(datosAudios$'nombre del audio'[1],mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],6]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],7]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],8]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],9]),
...
resultadoChroma$Primero_Audio_maximo <- c(datosAudios$'nombre del audio'[1],max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],6]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],7]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],8]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[1],9]),
...
if(nrow(auxTable) >= 2){
resultadoChroma$Segundo_Audio_minimo <- c(datosAudios$'nombre del audio'[2],min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],6]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],7]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],8]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],9]),
...
resultadoChroma$Segundo_Audio_medio <- c(datosAudios$'nombre del audio'[2],mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],6]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],7]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],8]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],9]),
...
resultadoChroma$Segundo_Audio_maximo <- c(datosAudios$'nombre del audio'[2],max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],6]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],7]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],8]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[2],9]),
...
if(nrow(auxTable) == 3){
resultadoChroma$Tercer_Audio_minimo <- c(datosAudios$'nombre del audio'[3],min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],6]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],7]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],8]),min(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],9]),
...
resultadoChroma$Tercer_Audio_medio <- c(datosAudios$'nombre del audio'[3],mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],6]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],7]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],8]),mean(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],9]),
...
resultadoChroma$Tercer_Audio_maximo <- c(datosAudios$'nombre del audio'[3],max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],6]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],7]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],8]),max(datosChroma[datosChroma$ejerciciopaciente_id ==  auxTable$Var1[3],9]),
...
resultadoEnergy <- expand.grid(c('ID','Energy'))
resultadoEnergy$Primero_Audio_minimo <- c(datosAudios$'nombre del audio'[1],min(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[1],6]))
resultadoEnergy$Primero_Audio_medio <- c(datosAudios$'nombre del audio'[1],mean(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[1],6]))
resultadoEnergy$Primero_Audio_maximo <- c(datosAudios$'nombre del audio'[1],max(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[1],6]))

if(nrow(auxTable) >= 2){
resultadoEnergy$Segundo_Audio_minimo <- c(datosAudios$'nombre del audio'[2],min(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[2],6]))
resultadoEnergy$Segundo_Audio_medio <- c(datosAudios$'nombre del audio'[2],mean(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[2],6]))
resultadoEnergy$Segundo_Audio_maximo <- c(datosAudios$'nombre del audio'[2],max(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[2],6]))}

if(nrow(auxTable) == 3){
resultadoEnergy$Tercer_Audio_minimo <- c(datosAudios$'nombre del audio'[3],min(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[3],6]))
resultadoEnergy$Tercer_Audio_medio <- c(datosAudios$'nombre del audio'[3],mean(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[3],6]))
resultadoEnergy$Tercer_Audio_maximo <- c(datosAudios$'nombre del audio'[3],max(datosenergy[datosenergy$ejerciciopaciente_id ==  auxTable$Var1[3],6]))}
...
resultadoF0_Vol_Prob <- expand.grid(c('ID','F0',"Probabilidad","Volumen"))
resultadoF0_Vol_Prob$Primero_Audio_minimo <- c(datosAudios$'nombre del audio'[1],min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],7]),min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],6]),min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8]))
resultadoF0_Vol_Prob$Primero_Audio_medio <- c(datosAudios$'nombre del audio'[1],mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],7]),mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],6]),mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8]))
resultadoF0_Vol_Prob$Primero_Audio_maximo <- c(datosAudios$'nombre del audio'[1],max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],7]),max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],6]),max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8]))

if(nrow(auxTable) >= 2){
resultadoF0_Vol_Prob$Segundo_Audio_minimo <- c(datosAudios$'nombre del audio'[2],min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],7]),min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],6]),min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8]))
resultadoF0_Vol_Prob$Segundo_Audio_medio <- c(datosAudios$'nombre del audio'[2],mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],7]),mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],6]),mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8]))
resultadoF0_Vol_Prob$Segundo_Audio_maximo <- c(datosAudios$'nombre del audio'[2],max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],7]),max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],6]),max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8]))}

if(nrow(auxTable) == 3){
resultadoF0_Vol_Prob$Tercer_Audio_minimo <- c(datosAudios$'nombre del audio'[3],min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],7]),min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],6]),min(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8]))
resultadoF0_Vol_Prob$Tercer_Audio_medio <- c(datosAudios$'nombre del audio'[3],mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],7]),mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],6]),mean(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8]))
resultadoF0_Vol_Prob$Tercer_Audio_maximo <- c(datosAudios$'nombre del audio'[3],max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],7]),max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],6]),max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8]))}

aux <- max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],7]) * datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8] / max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[1],8])
aux = c(aux,max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],7]) * datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8] / max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[2],8]))
aux = c(aux,max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],7]) * datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8] / max(datosprosody[datosprosody$ejerciciopaciente_id ==  auxTable$Var1[3],8]))

resultado2F0_Vol_Prob$loudness <- aux
...
kable(resultadoChroma[,1:3],caption="Tabla de los valores del maximos, media y baja de Chroma")

if(nrow(auxTable) >= 2){
kable(resultadoChroma[,4:6],caption="Tabla de los valores del maximos, media y baja de Chroma")}

if(nrow(auxTable) == 3){
kable(resultadoChroma[,7:9],caption="Tabla de los valores del maximos, media y baja de Chroma")}
...
kable(resultadoEnergy[,1:3],caption="Tabla de los valores maximos, medios y bajos de Energy")

if(nrow(auxTable) >= 2){
kable(resultadoEnergy[,4:6],caption="Tabla de los valores maximos, medios y bajos de Energy")}

if(nrow(auxTable) == 3){
kable(resultadoEnergy[,7:9],caption="Tabla de los valores maximos, medios y bajos de Energy")}
}
#############################################################################################
...
kable(resultadoF0_Vol_Prob[,1:3],caption="Tabla de los valores maximos, medios y bajos de F0, probabilidad y volumen")

if(nrow(auxTable) >= 2){
kable(resultadoF0_Vol_Prob[,4:6],caption="Tabla de los valores maximos, medios y bajos de F0, probabilidad y volumen")}

if(nrow(auxTable) == 3){
kable(resultadoF0_Vol_Prob[,7:9],caption="Tabla de los valores maximos, medios y bajos de F0, probabilidad y volumen")}
}
#############################################################################################
...
if(pareGemaps == 1){
 plot(vowelGraph)
kable(vowel,caption="Tabla de los valores del Vowel")
}
#############################################################################################
```
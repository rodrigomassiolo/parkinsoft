...
queryPaciente<- paste0("select usuario, genero,nacimiento,email,medicacion,idioma from users where id = (select user_id from egemaps where ejerciciopaciente_id IN ", paej,")")
...
kable(datosPaciente,caption="Datos del paciente")
...
kable(resumeneGemaps,caption="Variables sofre frecuencias medias, shimmer y jitter")
}
#############################################################################################
```
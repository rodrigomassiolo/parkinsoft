...
#ENERGY###########################################################################################################################################
if (parenergy == 1) {
queryenergy <- paste0("SELECT a.id, 'a', a.user_id, b.audio_name as 'ejerciciopaciente_id', frameIndex, frameTime, pcm_LOGenergy FROM ENERGY as a inner join pacienteEjercicio as b on a.ejerciciopaciente_id = b.id  WHERE ejerciciopaciente_id IN ", paej ," ORDER BY a.ejerciciopaciente_id, a.id")
...
colnames(resultadoEnergy) <- c("Energy")
rownames(resultadoEnergy) <- rep(c("audios","minimo","media","maximo"),nrow(auxTable))
...
#AUDSPEC###########################################################################################################################################
if (paraudspec == 1) {
queryaudspec <- paste0("SELECT a.id, 'a', a.user_id, b.audio_name as 'ejerciciopaciente_id', frameTime, audSpec_0, audSpec_1, audSpec_2, audSpec_3, audSpec_4, audSpec_5, audSpec_6, audSpec_7, audSpec_8, audSpec_9, audSpec_10, audSpec_11, audSpec_12, audSpec_13, audSpec_14, audSpec_15, audSpec_16, audSpec_17, audSpec_18, audSpec_19, audSpec_20, audSpec_21, audSpec_22, audSpec_23, audSpec_24, audSpec_25 FROM AUDSPEC as a inner join pacienteEjercicio as b on a.ejerciciopaciente_id = b.id  WHERE ejerciciopaciente_id IN ", paej ," ORDER BY a.ejerciciopaciente_id, a.id")
...
#F0 con probabilidad
if (parprosody == 1) {
queryprosody <- paste0("SELECT a.id, 'a', a.user_id,  b.audio_name as 'ejerciciopaciente_id', frameTime, voiceProb_sma, F0_sma, pcm_loudness_sma, name FROM PROSODY as a inner join pacienteEjercicio as b on a.ejerciciopaciente_id = b.id WHERE ejerciciopaciente_id IN ", paej ," ORDER BY a.ejerciciopaciente_id, a.id")
...
if (parchroma == 1) {
plot(chromagraph)
print("Muestra la energia en el audio de los 12 tonos a lo largo del tiempo")
plot(chromaLineMax)
print("Muestra cual fue el tono con mayor intensidad a largo del tiempo")
plot(maxmeanminGraph)
print("Muestra la maxima, media y menor energia de los 12 en un audio a lo largo del tiempo")
kable(resultadoChroma[,1:8],caption="Tabla de los valores del maximos, media y baja de Chroma")
}
if (parchroma == 1) {
  kable(resultadoChroma[,9:12],caption="Tabla de los valores del maximos, media y baja de Chroma")
}
#############################################################################################
...
if (parenergy == 1) {
plot(energygraph)
print("Muestra la energia en el audio a lo largo del tiempo")
kable(resultadoEnergy,caption="Tabla de los valores del maximos, media y baja de Energia")
...
if (paraudspec == 1) {
plot(audspectgraph)
print("Muestra la energia un audio en 26 bandas de 307 hz lo largo del tiempo")
plot(audspecLineMax)
print("Muestra la maxima energia de una de las bandas en un  audio a lo largo del tiempo")
plot(maxmeanminAudspectGraph)
print("Muestra la energia maxima, media y minima de las 26 bandas en un audio a lo largo del tiempo")
}
#############################################################################################
...
if (parprosody == 1) {
plot(F0_Prob)
print("Muestra la energia de la frecuencia base y la probabilidad de voz en un audio a lo largo del tiempo")
kable(resultadoProsody,caption="Tabla de los valores del maximos, media y baja de prosody")
}
#############################################################################################
...
if (pareGemaps == 1) {
plot(formanteGraph)
print("Muestra la formante en un audio")
kable(resumeneGemaps,caption="Tabla de los valores del maximos, media y baja de Energia")

}

if(pareGemaps == 1){
 plot(vowelGraph)
  print("Muestra la frecuencia F1 y F2 en realcion a las vocales")
kable(vowel,caption="Tabla de los valores del maximos, media y baja de Energia")
}
#############################################################################################
```
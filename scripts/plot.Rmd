...
#CHROMA###########################################################################################################################################
if (parchroma == 1) {
querychoma <- paste0("SELECT * FROM CHROMA WHERE ejerciciopaciente_id IN ", paej)
...
#ENERGY###########################################################################################################################################
if (parenergy == 1) {
queryenergy <- paste0("SELECT * FROM ENERGY WHERE ejerciciopaciente_id IN ", paej)
...
#AUDSPEC###########################################################################################################################################
if (paraudspec == 1) {
queryaudspec <- paste0("SELECT * FROM AUDSPEC WHERE ejerciciopaciente_id IN ", paej)
...
#F0 con probabilidad
if (parprosody == 1) {
queryprosody <- paste0("SELECT * FROM PROSODY WHERE ejerciciopaciente_id IN ", paej)
...
queryegemaps <- paste0("SELECT * FROM EGEMAPS WHERE ejerciciopaciente_id IN ", paej)
